  ...
  return (
    <footer className="bg-coffee-dark text-coffee-cream/80 pt-20 pb-10 border-t-4 border-coffee-terracotta">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Bottom */}
        <div className="pt-8 border-t border-coffee-light/20 flex flex-col items-center gap-6 text-sm text-coffee-cream/40">
          ...
          <p className="text-coffee-cream/30 text-xs text-center">
            Developed by Abhijeet, Sr. Software Engineer
          </p>
        </div>
      </div>
    </footer>
